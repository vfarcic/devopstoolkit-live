...
date = 2023-06-03T16:00:00+00:00
draft = false
+++
...
Now, I already talked about an alternative to Makefile in the [Say Goodbye to Makefile - Use Taskfile to Manage Tasks in CI/CD Pipelines and Locally](https://youtu.be/Z7EnwBaJzCk) video where I explored Taskfile. Many of you told me that its great, but quite a few of you sent me a message complaining about it being YAML. **"We do NOT want more YAML!"** **"YAML is evil!"** **"YAML ruined my marriage!"**.
...
Now, if you watched [Say Goodbye to Makefile - Use Taskfile to Manage Tasks in CI/CD Pipelines and Locally](https://youtu.be/Z7EnwBaJzCk) you might have noticed that the recipes I just executed with just are the same as those I had with Taskfile. That's on purpose. This is the same project and I wanted to compare the two based on the same criteria. I wanted to see why would we choose one over the other.
