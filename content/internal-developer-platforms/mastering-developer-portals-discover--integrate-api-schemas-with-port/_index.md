...
![](/logo/crossplane.png?height=6vw&classes=inline)
![](/logo/argo-cd.png?height=10vw&classes=inline)
![](/logo/github-actions.png?height=7vw&classes=inline)
...
![](img/self-serve-create-sqlclaim.png)
...
![](img/self-serve-create-sqlclaim-user-input.png)
...
![](img/self-serve-create-sqlclaim-edit-action.png)
...
![](img/self-serve-create-sqlclaim-action.png)
...
![](img/catalog-update-sqlclaim.png)
...
![](img/self-serve-delete-sqlclaim.png)
